                ...
                <form method="post" action="">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="username" id="input-username" placeholder="admin" value="admin">
                    </div>
                  </div>
                  <div class="form-group mb-0">
                    ...
                    <div class="input-group">
                      ...
                      <input type="password" class="form-control" id="input-password" name="password" placeholder="Password" value="123456">
                    </div>
                  </div>
                  <div class="mt-4">
                    <button type="button" class="btn btn-block btn-primary" onclick="document.getElementsByTagName('form')[0].submit()">Sign in</button></div>
                </form>
              </div>
